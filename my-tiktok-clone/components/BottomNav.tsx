...
const BottomNav: React.FC = () => (
  <div className="grid grid-cols-5 h-[43px] bg-black fixed bottom-0 w-full border-t border-gray-800">
    <div className="relative flex justify-center text-2xl text-white">
      <svg
        width="32px"
        height="32px"
        viewBox="0 0 48 48"
      ...
      <div className="absolute font-semibold text-[10px] text-white text-center top-[19px] max-h-[640px]:top-[28px]">
        Home
      </div>
    </div>
    <div className="relative flex justify-center text-2xl text-white">
      ...
      <div className="absolute font-semibold text-[10px] text-white text-center top-[19px] max-h-[640px]:top-[28px] opacity-75">
        Discover
      </div>
    </div>
    <div className="flex justify-center items-center text-2xl text-white h-[42px]">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 75 49"
